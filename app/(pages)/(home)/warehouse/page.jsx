...
export default async function Warehouse() {
  ...
  return (
    <div className='flex justify-center items-center h-screen w-full bg-[#2f406b] text-blue-900'>
      <div className='animate-slide_u1 flex-col gap-5 border-b border-[#8c96af] border-8 border-double shadow-xl p-6 w-11/12 max-w-3xl flex justify-center items-center'>
