  ...
  return (
    <div className='flex  justify-center items-start h-full w-full bg-blue-100 p-4 '>
      <div className='text-blue-800 w-[60vw] m-10 flex flex-col'>
        <h1 className='text-blue-900 font-bold mb-5 mt-20 flex justify-end opacity-70 text-5xl outline-2 outline-blue-400 rounded-2xl shadow-2xl font-serif px-2'> Warehouse</h1>

        <Section title="Engines">
          <ItemCard count="2" imgSrc={img} title="Toyota camry XSe 900 engine" price="k3500" altText="Engine 1" />
          <ItemCard count="44" imgSrc={img2} title="Ford mutang gt engine" price="k4000" altText="Engine 2" />
        </Section>

     
        <Section title="Tires">
          <ItemCard count="6" imgSrc={img3} title="enkei tire" price="k500" altText="Tire 1" />
          <ItemCard count="88" imgSrc={img4} title="michelin 76v tire" price="k400" altText="Tire 2" />
          <ItemCard count="9" imgSrc={img5} title="falken 5c tire" price="k450" altText="Tire 3" />
        </Section>

        <Section title="Transimission Convertors">
          <ItemCard count="111" imgSrc={img6} title="Transmission Converter" price="k2000" altText="Radiator 1" />
        </Section>

           <Section title="Radiators">
          <ItemCard count="2" imgSrc={img7} title="valeo f67" price="k2000" altText="Radiator 1" />
   <ItemCard count="90" imgSrc={img8} title="nissen 79g" price="k2000" altText="Radiator 1" />
